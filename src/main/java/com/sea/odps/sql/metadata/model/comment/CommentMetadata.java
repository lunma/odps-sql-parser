...
public final class CommentMetadata {
  ...
  public static CommentMetadata forTable(
    ...
    return new CommentMetadata(
        text, startIndex, stopIndex, CommentTargetType.TABLE, tableReference, null, null, null);
  }
  ...
  public static CommentMetadata forColumn(
      ...
      final ColumnReference columnReference) {
    return new CommentMetadata(
        text, startIndex, stopIndex, CommentTargetType.COLUMN, null, columnReference, null, null);
  }
  ...
  public static CommentMetadata forField(
      ...
      final FieldMetadata fieldMetadata) {
    return new CommentMetadata(
        text, startIndex, stopIndex, CommentTargetType.FIELD, null, null, fieldMetadata, null);
  }
